    ...
    <div class="overlay">
        <div class="loginContainer">
            ...
            <div class="dataRow">
                ...
                <input type="text" id="inpFirstName" v-model="registerData.userData.firstName" >
            </div>
            <div class="dataRow">
                <label for="inpSurname">Surname</label>
                <input type="text" id="inpSurname" v-model="registerData.userData.surname" >
            </div>
            <div class="dataRow">
                <label for="inpDisplayName">Display Name</label>
                <input type="text" id="inpDisplayName" v-model="registerData.userData.displayName" >
            </div>
            <div class="dataRow">
                <label for="inpDateOfBirth">Date of Birth</label>
                <input type="date" id="inpDateOfBirth" v-model="registerData.userData.dateOfBirth" >
            </div>
            <div class="dataRow">
