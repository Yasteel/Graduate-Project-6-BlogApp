...
namespace StolenBlog.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<StolenBlogUser> _signInManager;
        private readonly UserManager<StolenBlogUser> _userManager;
        private readonly IUserStore<StolenBlogUser> _userStore;
        private readonly IUserEmailStore<StolenBlogUser> _emailStore;
